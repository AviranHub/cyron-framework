...
@section('content')
    <div class="container mt-6 py-6">
        <div class="flex items-center bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md">
            <div class="flex items-center">
                <div class="flex items-center justify-center w-10 h-10 ml-2 bg-blue-100 dark:bg-blue-900 rounded-full mr-2">
                    <i class="fa fa-home text-blue-600 dark:text-blue-300"></i>
                </div>
                <a href="{{ route('home') }}" class="text-blue-600 hover:underline">کلبه کتاب</a>
                <i class="fa fa-chevron-left mx-2 text-gray-400"></i>
				<a class="text-blue-600 hover:underline" href="{{ route('books') }}">کتاب ها</a>
                <i class="fa fa-chevron-left mx-2 text-gray-400"></i>
				<a class="text-blue-600 hover:underline" href="{{ route('book',['slug' => $book->slug]) }}">{{ $book->title }}</a>
            </div>
        </div>
    </div>
            ...
            <div class="flex flex-col p-2  bg-white dark:bg-gray-700 shadow-lime rounded-xl justify-center">
                ...
                <div class="flex flex-col p-2 ">
                    <div class="book-cover-box">
                        <img src="{{ asset('storage/book/' . $book->cover) }}" alt=""
                    ...
                    <div class="flex flex-col p-2 font-vazir text-lg">
                        ...
                        <p class="">نویسنده :
                            ...
                            @else
                                <span class="text-green-500">{{ $book->author }}</span>
                            @endif
                        </p>
                ...
                <div class="inline-flex flex-col items-center justify-center p-1 font-vazir fs-18 gap-2">
                    ...
                    {{-- <a href="{{ route('buy-book', ['slug' => $book->slug]) }}" class="w-48 text-green-500 rounded-lg border-2 border-green-500 text-decoration-none text-center py-2 px-6">خرید نسخه کامل</a> --}}

                    
                    
                    <a href="{{ route('book.reader', ['slug' => $book->slug]) }}" class="w-48 text-red-500 rounded-lg border-2 border-red-500 text-decoration-none text-center py-2 px-6">نسخه PDF</a>
        ...
        <div class="container w-full lg:w-2/3">
            <div
                ...
                <p class="font-vazir text-green-500 text-2xl text-right m-0-5  font-vazir br10 shadow-lime p-2">
                    {{ $book->title }}</p>
                <div class="font-vazir text-lg text-right  m-0-5  font-vazir br10 shadow-lime p-2">
                ...
                <nav aria-label="Page navigation example">
                    ...
                    <ul class="flex items-center -space-x-px h-10 text-base">
                        <li>
                            <a href="{{ $prevPage > 0 ? route('online-ready', ['slug' => $book->slug, 'id' => $prevPage]) : '#' }}"
                        ...
                        <li>
                            <a href="{{ $nextPage <= $totalPages ? route('online-ready', ['slug' => $book->slug, 'id' => $nextPage]) : '#' }}"
