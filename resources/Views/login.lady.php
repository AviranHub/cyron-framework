...
<div class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-sm mx-auto">
        <div class="flex justify-center mb-6">
            <img alt="Logo" class="h-12" height="50" src="@asset('img/logo.png')" width="50" />
        </div>
        @errors
        @enderrors
        @isset($msg)
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg">
            <form action="@route('login.submit')" method="post">
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="login" id="email" type="email" placeholder="your@gmail.com"  value="{{ old('login') }}" />
                </div>
                <div class="mb-4">
