...
<div class="admin-dashboard">
    ...
    <section class="dashboard-grid">
        <div class="dashboard-panel activity-panel"><div class="panel-heading"><div><span class="eyebrow">LIVE FEED</span><h2>آخرین فعالیت‌ها</h2></div><a href="{{ route('admin.activities.index') }}">همه فعالیت‌ها</a></div>
