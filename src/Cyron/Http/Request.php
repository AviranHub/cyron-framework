...
class Request
{
    ...
    public function fileData($key): ?array
    {
    ...
    {
        return \Cyron\Routing\Route::is($pattern);
    }
     ...
     * @return \Cyron\Http\ErrorBag|null
     */
    public function validate($rules, $messages = [])
    {
        $validator = new \Cyron\Validation\Validator($this->all(), $rules, $messages);
        $validator->validate();
