...
class LoginManager
{
    ...
    public static function completeTwoFactor(string $code): array
    {
        ...
        $userModel = \Cyron\Database\ModelRegistry::get('user');
        ...
        unset($_SESSION['pending_auth']);
        return self::complete($key, $user, ['two_factor'=>true,'channel'=>$channel], (bool) ($pending['remember'] ?? false));
    }
    ...
    private static function complete(string $key, $user, array $context=[], bool $remember = false): array
    {
