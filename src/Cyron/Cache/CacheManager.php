...
namespace Cyron\Cache;

use Cyron\Cache\drivers\DriverInterface;
use Cyron\Cache\drivers\FileDriver;
...
class CacheManager
{
    ...
    {
        if (self::$driver === null) {
            $path = defined('STORAGE_PATH') ? STORAGE_PATH . '/cache/data' : dirname(__DIR__, 3) . '/storage/cache/data';
