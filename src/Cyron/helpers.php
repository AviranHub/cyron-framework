...
if (!function_exists('event')) {
    function event($event = null, ...$arguments)
    {
        if ($event === null) {
            return \Cyron\Events\Event::dispatcher();
        }

        return \Cyron\Events\Event::dispatch($event, ...$arguments);
    }
}
...
if (!function_exists('__')) {
    ...
    {
        return \Cyron\Localization\Translator::get($key, $replace);
    }
}
...
if (!function_exists('locale')) {
    ...
    {
        return \Cyron\Localization\Translator::getLocale();
    }
}
...
if (!function_exists('is_rtl')) {
    ...
    {
        return \Cyron\Localization\Translator::isRtl();
    }
}
...
if (!function_exists('set_locale')) {
    ...
    {
        \Cyron\Localization\Translator::setLocale($locale);
    }
}
...
//     {
//         if (class_exists('Cyron\\Routing\\Route')) {
//             // استفاده از instance روتر
//             $router = \Cyron\Routing\Route::getInstance();
...
if (!function_exists('redirect')) {
    class Redirect
    {
        ...
        {
            $url = \Cyron\Routing\Route::url($name, $parameters);
            return self::to($url);
        }
...
if (!function_exists('mailer')) {
     ...
     * 
    * @return \Cyron\Mail\Mailer
     */
    function mailer()
    {
        return new Cyron\Mail\Mailer();
    }
}
...
if (!function_exists('send_mail')) {
    ...
    {
        return Cyron\Mail\Mailer::quick($to, $subject, $body, $from);
    }
}
...
if (!function_exists('config')) {
    function config($key, $default = null)
    {
        ...
        if (!isset($config[$file])) {
            $configDir = defined('APP_PATH')
                ? APP_PATH . '/Config'
                : (defined('BASE_PATH') ? BASE_PATH . '/app/Config' : dirname(__DIR__, 2) . '/app/Config');
...
if (!function_exists('auth')) {
    function auth()
    {
        return new class {
            ...
            {
                return \Cyron\Authentication\Auth::check();
            }
...
if (!function_exists('storage')) {
    function storage(string $disk = 'public'): \Cyron\Storage\DriverInterface
    {
        return \Cyron\Storage\StorageManager::disk($disk);
    }
}
...
if (!function_exists('cache')) {
    ...
    {
        if ($key === null) {
            return \Cyron\Cache\CacheManager::driver();
        }
        if ($value === null) {
            return \Cyron\Cache\CacheManager::get($key);
        }
        return \Cyron\Cache\CacheManager::put($key, $value, $seconds);
    }
}
...
if (!function_exists('logger')) {
    ...
    {
        if (func_num_args() === 0) {
            return \Cyron\Log\LogManager::driver();
        }
        return \Cyron\Log\LogManager::$level($message, $context);
    }
}
...
if (!function_exists('token')) {
    ...
    {
        return \Cyron\Authentication\Tokenizer::make($bytes);
    }
}
...
if (!function_exists('component')) {
    ...
    * @return \Cyron\Lady\ComponentManager
     */
    function component()
    {
        return \Cyron\Lady\ComponentManager::getInstance();
    }
}
